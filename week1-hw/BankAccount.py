...
class Account:
    ...
    def __init__(self, name, balance, password):
        ...
        self.interestAlreadyAdded = False
    ...
    def addInterest(self):
        if self.interestAlreadyAdded:
            print(
                "Interest has already been added. This operation cannot be performed again."
            )
        else:
            self.interestAlreadyAdded = True
            ...
            print(f"Interest has been added. Your balance is now {self.balance}")
